...
if(this.color_switch){ 
     groundpaint(this.R,this.G,this.B);    
}
 
 
if(this.save_file && !this.crop_event){
    psdjpegsave();    
} 
 ...
 //----------------------------------------------------------------------------------------------------------------------------------------------
 //---------------------------------------------------------------------------------------------------------------------------------------------- 
  if(crop_obj.open_file && !crop_obj.crop_event){//開いたファイル全てに処理
